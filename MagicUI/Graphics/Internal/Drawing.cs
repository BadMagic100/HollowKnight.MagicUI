...
namespace MagicUI.Graphics.Internal
{
    ...
    {
        private static readonly Texture2D aaLineTex;
        private static readonly Texture2D lineTex;
        private static readonly Material blitMaterial;
        private static readonly Material blendMaterial;
        ...
        public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width, bool antiAlias)
        {
            ...
            UnityEngine.Graphics.DrawTexture(lineRect, tex, lineRect, 0, 0, 0, 0, color, mat);
            if (antiAlias)
            {
                UnityEngine.Graphics.DrawTexture(lineRect, tex, lineRect, 0, 0, 0, 0, color, mat);
            }
